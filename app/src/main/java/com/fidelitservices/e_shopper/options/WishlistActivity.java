...
import com.fidelitservices.e_shopper.product.ItemDetailsActivity;
import com.fidelitservices.e_shopper.startup.MainActivity;
import com.fidelitservices.e_shopper.utility.ImageUrlUtils;
import com.facebook.drawee.view.SimpleDraweeView;

import java.util.ArrayList;

import static com.fidelitservices.e_shopper.fragments.ImageListFragment.STRING_IMAGE_POSITION;
import static com.fidelitservices.e_shopper.fragments.ImageListFragment.STRING_IMAGE_URI;
...
public class WishlistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout layoutNoItems = (LinearLayout) findViewById(R.id.ll_no_wishlist);

        if (wishlistImageUri.isEmpty()){
